...
function Registro({ cargando = false }) {
  const { register } = useAuth(); //cogemos register() del contexto
  ...
  // SIN CAMBIOS: la validación se queda igual
  ...
  //ELIMINADO registrarPorDefecto, esa lógica ahora vive en AuthContext
  ...
  const manejarSubmit = async (e) => {
    ...
    // SIN CAMBIOS: todas las validaciones se quedan igual
    ...
    try {
      // CAMBIADO: antes elegía entre onRegistrar o registrarPorDefecto
      // Ahora siempre usa register() del contexto, que ya hace el fetch y guarda el token
